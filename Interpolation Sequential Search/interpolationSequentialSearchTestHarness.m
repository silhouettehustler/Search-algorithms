%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Title:     Interpolation Sequential Search Test Harness
...
for N = 1:maxArraySize    
    ...
    for searchTarget = 1:N
        comparisons(searchTarget) = interpolationSequentialSearch(array, searchTarget);        
    end
...
title('Interpolation Sequential Search (Successful)','FontSize', 14);
xlim([0 maxArraySize]);
ylim([0 max(max_comps)]);
 
print -f1 -r300 -dbmp interpolataionSequentialSearchSuccessful.bmp
